...
namespace MusicIndexer
{
    public static class DatabaseConfig
    {
        ...
        public static string ConnectionString = "DSN=dalet51;Uid=dalet_admin;Pwd=dalet_admin;";
    }
    class Program
    {
        ...
        private static int soundfile_id;
        ...
        static void Main(string[] args)
        {
            ...
            // Step 2b: Write the list to a file
            string indexFilePath = Path.Combine(musicFolderPath, "music_index.txt");
            using (StreamWriter writer = new StreamWriter(indexFilePath))
            {
                foreach (var song in songs)
                {
                    writer.WriteLine($"{song.Title},{song.Artist},{(int)song.Duration},{song.FilePath}");
                }
            }
        ...
        static void InsertSongsIntoDatabase(List<SongInfo> songs)
        {
            ...
            string connectionString = "DSN=dalet51;Uid=dalet_admin;Pwd=dalet_admin;";
